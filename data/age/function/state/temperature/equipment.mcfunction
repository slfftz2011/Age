...
execute if items entity @s armor.chest minecraft:copper_chestplate run scoreboard players add @s metal_modify 5
execute if items entity @s armor.legs minecraft:copper_leggings run scoreboard players add @s metal_modify 5
execute if items entity @s armor.feet minecraft:copper_boots run scoreboard players add @s metal_modify 5

# 普通金属（每件 5）
execute if items entity @s armor.head #age:metal_helmets unless items entity @s armor.head minecraft:copper_helmet run scoreboard players add @s metal_modify 5
execute if items entity @s armor.chest #age:metal_chestplates unless items entity @s armor.chest minecraft:copper_chestplate run scoreboard players add @s metal_modify 5
execute if items entity @s armor.legs #age:metal_leggings unless items entity @s armor.legs minecraft:copper_leggings run scoreboard players add @s metal_modify 5
