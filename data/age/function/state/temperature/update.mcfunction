...
execute if items entity @s armor.head minecraft:copper_helmet if items entity @s armor.chest minecraft:copper_chestplate if items entity @s armor.legs minecraft:copper_leggings if items entity @s armor.feet minecraft:copper_boots run scoreboard players set @s temperature_trend 0
execute if items entity @s armor.head minecraft:copper_helmet if items entity @s armor.chest minecraft:copper_chestplate if items entity @s armor.legs minecraft:copper_leggings if items entity @s armor.feet minecraft:copper_boots run scoreboard players set @s temperature_timer 0
