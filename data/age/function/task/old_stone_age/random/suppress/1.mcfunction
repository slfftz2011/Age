...
execute unless entity @a[team=old_stone_age,tag=task_done] if score old_stone_age zombie_all matches 5.. run function age:task/old_stone_age/random/suppress/1_c