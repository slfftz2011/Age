execute unless entity @s[tag=task_done] unless score @s chicken_hunt = @s chicken_updata run title @s actionbar ["",{"text":"🏹 狩猎: 鸡 ","color":"#554411"},{"score":{"name":"@s","objective":"chicken_hunt"},"color":"gray"},{"text":"/5","color":"gray"}]
