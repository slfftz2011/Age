execute unless entity @s[tag=task_done] unless score @s pig_hunt = @s pig_updata run title @s actionbar ["",{"text":"🏹 狩猎: 猪 ","color":"#554411"},{"score":{"name":"@s","objective":"pig_hunt"},"color":"gray"},{"text":"/5","color":"gray"}]
