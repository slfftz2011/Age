...
execute if score old_stone_age task matches 21 run bossbar set old_stone_age name ["当前时代 - ", {text:"旧石器时代",color:"#424529"}, " 当前任务 - ", {text:"[捕获] 热带鱼 x3",color:"#55AAFF"}]
execute if score old_stone_age task matches 22 run bossbar set old_stone_age name ["当前时代 - ", {text:"旧石器时代",color:"#424529"}, " 当前任务 - ", {text:"[捕获] 鱿鱼 x3",color:"#55AAFF"}]
execute if score old_stone_age task matches 23 run bossbar set old_stone_age name ["当前时代 - ", {text:"旧石器时代",color:"#424529"}, " 当前任务 - ", {text:"[捕获] 发光鱿鱼 x3",color:"#55AAFF"}]
execute if score old_stone_age task matches 24 run bossbar set old_stone_age name ["当前时代 - ", {text:"旧石器时代",color:"#424529"}, " 当前任务 - ", {text:"[捕获] 河豚 x2",color:"#55AAFF"}]
