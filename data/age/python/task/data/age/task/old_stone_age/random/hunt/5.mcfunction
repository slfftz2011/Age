execute unless entity @s[tag=task_done] unless score @s horse_hunt = @s horse_updata run title @s actionbar ["",{"text":"🏹 ","color":"#CFCF5F"},{"text":"狩猎: 马 ","color":"#CFCF5F"},{"score":{"name":"@s","objective":"horse_hunt"},"color":"gray"},{"text":"/3","color":"gray"}]
